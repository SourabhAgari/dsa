...
class MaximumSumSubArrayKTest {
    ...
    void returnsMaximumSumForAWindowOfThree() {
        ...
        assertEquals(9, MaximumSumSubArrayK.getMaxSubArrayTwo(numbers, 3));
    }
    @Test
    void returnsLargestValueForAWindowOfOne() {
        int[] numbers = {2, -1, 5, 1};
        assertEquals(5, MaximumSumSubArrayK.getMaxSubArrayTwo(numbers, 1));
    }
    @Test
    void handlesAnArrayContainingOnlyNegativeValues() {
        int[] numbers = {-2, -3, -1, -4};
        assertEquals(-4, MaximumSumSubArrayK.getMaxSubArrayTwo(numbers, 2));
    }
    @Test
    void returnsTotalWhenWindowMatchesArrayLength() {
        int[] numbers = {1, 2, 3};
        assertEquals(6, MaximumSumSubArrayK.getMaxSubArrayTwo(numbers, 3));
    }
    @Test
    void findsMaximumAcrossOverlappingWindows() {
        int[] numbers = {1, 4, 2, 10, 23, 3, 1, 0, 20};
        assertEquals(39, MaximumSumSubArrayK.getMaxSubArrayTwo(numbers, 4));
    }
}
